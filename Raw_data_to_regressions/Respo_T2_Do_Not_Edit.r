...
file <- read.csv("/Users/shannonmurphy/Desktop/Respirometry/T2/PCOM/T2_PCOM_run_9_light-9_13_2023_O2.csv", header = FALSE)
...
slope_channel_c_blank <- na.omit(slope_table_light$Slope[slope_table_light$Channel == 6])
slope_channel_g_blank <- na.omit(slope_table_light$Slope[slope_table_light$Channel == 10])

# Calculate differences for channels 2, 5, 8, and 10
difference_channel_1 <- na.omit(slope_table_light$Slope[slope_table_light$Channel == 1]) - slope_channel_c_blank
difference_channel_4 <- na.omit(slope_table_light$Slope[slope_table_light$Channel == 4]) - slope_channel_c_blank
...
slope_table_light$Light_Slope_Difference[slope_table_light$Channel == 1] <- difference_channel_1
slope_table_light$Light_Slope_Difference[slope_table_light$Channel == 4] <- difference_channel_4
...
# Calculate differences for channels 3, 6, 9, and 
difference_channel_2 <- na.omit(slope_table_light$Slope[slope_table_light$Channel == 2]) - slope_channel_g_blank
difference_channel_3 <- na.omit(slope_table_light$Slope[slope_table_light$Channel == 3]) - slope_channel_g_blank
difference_channel_5 <- na.omit(slope_table_light$Slope[slope_table_light$Channel == 5]) - slope_channel_g_blank
difference_channel_8 <- na.omit(slope_table_light$Slope[slope_table_light$Channel == 8]) - slope_channel_g_blank
difference_channel_10 <- na.omit(slope_table_light$Slope[slope_table_light$Channel == 10]) - slope_channel_g_blank
...
file <- read.csv("/Users/shannonmurphy/Desktop/Respirometry/T2/PCOM/T2_PCOM_run_9_dark_9_13_2023_O2.csv", header = FALSE)
...
slope_channel_c_blank <- na.omit(slope_table_dark$Slope[slope_table_dark$Channel == 6])
slope_channel_g_blank <- na.omit(slope_table_dark$Slope[slope_table_dark$Channel == 10])

# Calculate differecces for channels 2, 5, 8, and 10
difference_channel_1 <- na.omit(slope_table_dark$Slope[slope_table_dark$Channel == 1]) - slope_channel_c_blank
difference_channel_4 <- na.omit(slope_table_dark$Slope[slope_table_dark$Channel == 4]) - slope_channel_c_blank
...
# Add differences to the existing data frame
slope_table_dark$Dark_Slope_Difference[slope_table_dark$Channel == 1] <- difference_channel_1
slope_table_dark$Dark_Slope_Difference[slope_table_dark$Channel == 4] <- difference_channel_4
...
difference_channel_2 <- na.omit(slope_table_dark$Slope[slope_table_dark$Channel == 2]) - slope_channel_g_blank
difference_channel_3 <- na.omit(slope_table_dark$Slope[slope_table_dark$Channel == 3]) - slope_channel_g_blank
difference_channel_5 <- na.omit(slope_table_dark$Slope[slope_table_dark$Channel == 5]) - slope_channel_g_blank
difference_channel_8 <- na.omit(slope_table_dark$Slope[slope_table_dark$Channel == 8]) - slope_channel_g_blank
difference_channel_10 <- na.omit(slope_table_dark$Slope[slope_table_dark$Channel == 10]) - slope_channel_g_blank
...
file_path <- '/Users/Shannonmurphy/Desktop/Respirometry/T2/T2_PCOMP_Frag_ID_List.xlsx'
...
write.csv(merged_slope_table, file = '/Users/Shannonmurphy/Desktop/Respirometry/R_Analyzed/T2/P_Comp/T2_PCOMP_run_9_analyzed.csv', row.names = FALSE)
