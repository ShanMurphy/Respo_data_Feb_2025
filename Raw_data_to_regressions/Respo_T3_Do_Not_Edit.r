...
file <- read.csv("/Users/shannonmurphy/Desktop/Respirometry_Raw_Data/T3/PCOM/T3_PCOM_run_5_light_10_8_2023_O2.csv", header = FALSE)
...
slope_channel_e_blank <- na.omit(slope_table_light$Slope[slope_table_light$Channel == 2])
slope_channel_c_blank <- na.omit(slope_table_light$Slope[slope_table_light$Channel == 8])

# Calculate differences for channels 2, 5, 8, and 10
difference_channel_1 <- na.omit(slope_table_light$Slope[slope_table_light$Channel == 1]) - slope_channel_e_blank
difference_channel_5 <- na.omit(slope_table_light$Slope[slope_table_light$Channel == 5]) - slope_channel_e_blank
difference_channel_6 <- na.omit(slope_table_light$Slope[slope_table_light$Channel == 6]) - slope_channel_e_blank
difference_channel_7 <- na.omit(slope_table_light$Slope[slope_table_light$Channel == 7]) - slope_channel_e_blank
...
difference_channel_10 <- na.omit(slope_table_light$Slope[slope_table_light$Channel == 10]) - slope_channel_c_blank
difference_channel_8 <- na.omit(slope_table_light$Slope[slope_table_light$Channel == 8]) - slope_channel_c_blank
...
file <- read.csv("/Users/shannonmurphy/Desktop/Respirometry_Raw_Data/T3/PCOM/T3_PCOM_run_5_dark_10_8_2023_O2.csv", header = FALSE)
...
slope_channel_e_blank <- na.omit(slope_table_dark$Slope[slope_table_dark$Channel == 2])
slope_channel_c_blank <- na.omit(slope_table_dark$Slope[slope_table_dark$Channel == 8])

# Calculate differecces for channels 2, 5, 8, and 10
difference_channel_1 <- na.omit(slope_table_dark$Slope[slope_table_dark$Channel == 1]) - slope_channel_e_blank
difference_channel_5 <- na.omit(slope_table_dark$Slope[slope_table_dark$Channel == 5]) - slope_channel_e_blank
difference_channel_6 <- na.omit(slope_table_dark$Slope[slope_table_dark$Channel == 6]) - slope_channel_e_blank
difference_channel_7 <- na.omit(slope_table_dark$Slope[slope_table_dark$Channel == 7]) - slope_channel_e_blank
...
difference_channel_10 <- na.omit(slope_table_dark$Slope[slope_table_dark$Channel == 10]) - slope_channel_c_blank
difference_channel_8 <- na.omit(slope_table_dark$Slope[slope_table_dark$Channel == 8]) - slope_channel_c_blank
...
file_path <- '/Users/Shannonmurphy/Desktop/Respirometry/T3/T3_PCOMP_Frag_ID_List.xlsx'
...
write.csv(merged_slope_table, file = '/Users/Shannonmurphy/Desktop/Respirometry/R_Analyzed/T3/P_Comp/T3_PCOMP_run_8_analyzed.csv', row.names = FALSE)
